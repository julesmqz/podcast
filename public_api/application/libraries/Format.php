...
class Format {
    ...
    {
        // $basenode = 'rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:itunesu="http://www.itunesu.com/feed" version="2.0"';
        if ($data === NULL && func_num_args() === 0)
        {
            $data = $this->_data;
        }
        ...
        foreach ($data as $key => $value)
        {
            ...
            if ($key === '_attributes' && (is_array($value) || is_object($value)))
            {
                ...
                foreach ($attributes as $attribute_name => $attribute_value)
                {
                    ...
                    // $structure->addAttribute($attribute_name, $attribute_value,$namespace);
                }
            }
            ...
            {
                // echo $key;
                $namespace = strstr( $key, ':' ) ? true : false;
                $node = $structure->addChild($key,nulla);
                // $node = $structure->addChild($key,null,$namespace);
